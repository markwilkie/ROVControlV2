...
namespace GAW
{
    ...
    public partial class CircleControl : UserControl
    {
        ...
        public CircleControl()
        {
            ...
            markerPoly[0] = new PointF(0.89F,  0.00F);
			markerPoly[1] = new PointF(0.84F,  0.12F);
			markerPoly[2] = new PointF(0.99F,  0.00F);
            markerPoly[3] = new PointF(0.84F, -0.12F);
		...
		private enum MouseMode { CannotDrag, CanDrag, Dragging };
